...
export const Feedback = () => {
  ...
  useEffect(() => {
    if (interviewId) {
      //fetch interview and feedbacks from firebase

      //fetching the interview id with the position and stuff find it in types
      ...
      //accoding to the id of the interviewer fetch the interview's feedbacks and rating
    ...
    <div className="flex flex-col w-full gap-8 py-5">
      ...
      <div className="flex items-center justify-between w-full gap-2">
        <CustomBreadCrumb
          ...
          breadCrumbItems={[
            { label: "Mock Interviws", link: "/generate" },
            {
      ...
      {/* shows the interview card and details of rated interview */}
