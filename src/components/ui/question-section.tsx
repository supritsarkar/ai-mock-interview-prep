...
export const QuestionSection = ({ questions }: QuestionSectionProps) => {
  ...
  const [isWebCam, setWebCam] = useState<boolean>(false);
  ...
  return (
    <div className="w-full min-h-96 border rounded-md p-4">
      ...
      >
        <TabsList className="bg-transparent w-full flex-wrap items-center justify-start gap-4">
          {questions.map((tab, i) => (
            <TabsTrigger
              className={cn(
